      ...
      <div className="flex flex-row container mx-auto max-w-screen-xl px-5">
        <div>
          <Post
            displayName="Mr X"
            userName="MR X"
            text="Lequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.."
